...
namespace TranslatoServiceLibrary.X
{
    ...
    public enum CODE : int
    {
        ...
        //LOGINUSER(YY) = 11
        CTRUSER_LOGINUSER_FAILURE_INITIAL = 111110,
        CTRUSER_LOGINUSER_FAILURE_INVALID_USERNAME = 111111,
        CTRUSER_LOGINUSER_FAILURE_INVALID_EMAIL = 111112,
        CTRUSER_LOGINUSER_FAILURE_INVALID_USERNAME_AND_EMAIL = 111113,
        ...
        //--------------------------------------------------
        //DBLANGUAGES(XX) = 12
        //INSERTLANGUAGE(YY) = 10
        DBLANGUAGES_INSERTLANGUAGE_EXCEPTION = 121088,
        //CTRLANGUAGE(XX) = 13
        //--------------------------------------------------
        ...
        //DBFILES(XX) = 16
        //INSERTFILE(YY) = 10
        DBFILES_INSERTFILE_EXCEPTION = 161088,
        //CTRFILE(XX) = 17
        //--------------------------------------------------
        ...
        //DBUJOBS(XX) = 20
        //INSERTJOB(YY) = 10
        DBJOBS_INSERTJOB_EXCEPTION = 201088, 
        //CTRJOB(XX) = 21
        //--------------------------------------------------
        ...
        //--------------------------------------------------
        //DBSUBMISSIONS(XX) = 22
        //INSERTSUBMISSION(YY) = 10
        DBSUBMISSIONS_INSERTSUBMISSION_EXCEPTION = 221088, 
        //CTRSUBMISSION(XX) = 23
        //--------------------------------------------------
    }
}
